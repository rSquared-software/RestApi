...
public class RestApi {
	...
	private static final MainThreadExecutor DEFAULT_MAIN_THREAD_EXECUTOR = new MainThreadExecutor();
	...
	private RestApi(long timeout, @NonNull String url, @Nullable BasicAuth basicAuth,
